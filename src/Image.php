...
namespace tp5er\Images;

use Exception;
use tp5er\Images\Driver\Gd;
use tp5er\Images\Driver\GIF;
use tp5er\Images\Driver\Imagick;
...
class Image
{
    ...
    public function __construct($type = self::IMAGE_GD, $imgname = null)
    {
        ...
        $class     = "tp5er\\Images\\Driver\\{$class}";
